...
public class CatanBoardTest {
	...
	IBoardElement[][] elements = {
		{ new BoardStructure(StructureType.None), new BoardConnection(ConnectionType.Void),
			new BoardStructure(StructureType.None), },
		{ new BoardConnection(ConnectionType.Void), new BoardTerrain(0, TerrainType.None),
			new BoardConnection(ConnectionType.Void), },
		{ new BoardStructure(StructureType.None), new BoardConnection(ConnectionType.Void),
			new BoardStructure(StructureType.None), }, };
    ...
    public void itMustFailIfAFalseConnectionIsProvided()
	    throws InvalidBoardDimensionsException, InvalidBoardElementException {
	IBoardElement[][] elements = {
		{ new BoardStructure(StructureType.None), new BoardStructure(StructureType.None),
			new BoardStructure(StructureType.None), },
		{ new BoardConnection(ConnectionType.Void), new BoardTerrain(0, TerrainType.None),
			new BoardConnection(ConnectionType.Void), },
		{ new BoardStructure(StructureType.None), new BoardConnection(ConnectionType.Void),
	...
	IBoardElement[][] elements = {
		{ new BoardStructure(StructureType.None), new BoardConnection(ConnectionType.Void),
			new BoardStructure(StructureType.None), },
		{ new BoardConnection(ConnectionType.Void), new BoardConnection(ConnectionType.Void),
			new BoardConnection(ConnectionType.Void), },
		{ new BoardStructure(StructureType.None), new BoardConnection(ConnectionType.Void),
			new BoardStructure(StructureType.None), }, };
	new CatanBoard(3, 3, elements);
    ...
    public void itMustFailIfAFalseStructureIsProvided()
	    throws InvalidBoardDimensionsException, InvalidBoardElementException {
	IBoardElement[][] elements = {
		{ new BoardTerrain(0, TerrainType.None), new BoardConnection(ConnectionType.Void),
			new BoardStructure(StructureType.None), },
		{ new BoardConnection(ConnectionType.Void), new BoardTerrain(0, TerrainType.None),
			new BoardConnection(ConnectionType.Void), },
		{ new BoardStructure(StructureType.None), new BoardConnection(ConnectionType.Void),
