...
public interface IDeterministicNumberGenerator extends INumberGenerator {
   ...
   * 
   * An offset of zero is equivalent to request the next production number.
   * A positive offset is equivalent to request production numbers next to the next one.
   * A negative offset is equivalent to request production numbers previous to the next one.
   * 
